...
from BornFree.utils import elements
from BornFree.utils import units as unit_conversion
...
class Atom:
    ...
    def coords_angstrom(self):
        """Get atom coordinates in Angstrom units."""
    ...
    @property
    def element(self):
        """Get the element symbol for this atom."""
