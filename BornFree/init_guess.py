...
"""Initial position generators for electrons and atoms in periodic systems."""
...
def init_electrons(
    ...
    Args:
        ...
        cell: Internal representation of simulation cell.
        latvec: Lattice vector of cell.
        electrons: List of up, down electrons.
        batch_size: Batch size for simulation.
        init_width: Standard deviation of Gaussian used for initialization.
            Defaults to 0.5.

    Returns:
        JAX array with shape [batch_size, n_ele * ndim].
...
def init_atom(
    ...
    """Initializes atom positions with Gaussian noise.
    ...
    Returns:
        JAX array with shape [batch_size, n_atom * ndim].
...
def pyscf_to_cell(cell: PyscfCell) -> Sequence[system.Atom]:
